	...
	**/
	...
	function iatExtension(options)
	{
		...
		var iatObj =
		{
			...
			EDASlide: '<div><img src="https://raw.githubusercontent.com/matthewcgraham/IATStudy/master/Empatica.jpg" alt="PLEASE PRESS SENSOR BUTTON NOW" width="200" height="300"><p align="center" style="font-size:20px; font-family:arial">'+
